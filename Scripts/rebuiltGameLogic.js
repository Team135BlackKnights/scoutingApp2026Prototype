/*/
    This could be used for the button map, The idea is that for this map it will increment evrey button when pressed by one and display the count on the button,
    their is not problem with making more buttons it is super easy with only one line of code to do. 
/*/
